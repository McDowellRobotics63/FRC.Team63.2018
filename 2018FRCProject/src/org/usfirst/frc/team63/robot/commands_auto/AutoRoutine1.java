...
public class AutoRoutine1 extends CommandGroup {
    ...
    public static final double DIST_SCALE = 300; //Distance from the starting point to the scale
    ...
    public AutoRoutine1(String fieldSetup, int switches) {
    	...
    	if(botPos == 'm') {
    		...
    		addSequential(new AutoDriveFixedDistance(DIST_SWITCH-DIST_UNTIL_TURN));
    		...
    		addSequential(new AutoDriveFixedDistance(DIST_SCALE));
    		...
    		//just drive forward
    		addSequential(new AutoDriveFixedDistance(DIST_LINE));
    	}
